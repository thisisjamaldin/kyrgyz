...
struct home_widgetLiveActivity_Previews: PreviewProvider {
    static let attributes = home_widgetAttributes(name: "Me")
    static let contentState = home_widgetAttributes.ContentState(value: 3)
